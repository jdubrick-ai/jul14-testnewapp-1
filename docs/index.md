...
!!! info
    ...
    **Source Code Repository:** [https://github.com/jdubrick-ai/jul14-testnewapp-1](https://github.com/jdubrick-ai/jul14-testnewapp-1)

    **GitOps Repository:** [https://github.com/jdubrick-ai/jul14-testnewapp-1-gitops](https://github.com/jdubrick-ai/jul14-testnewapp-1-gitops)

# **Usage**

To access the jul14-testnewapp-1 application that was deployed using the Software Template, complete the following instructions:
